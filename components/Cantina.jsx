...
const Cantina = () => {
  return (
    <div className="flex flex-col-reverse lg:flex-row h-auto lg:basis-full justify-center lg:items-end">
      <div className="flex p-14 w-[clamp] flex-col lg:mx-36 lg:mb-32 basis-[53%] h-fit lg:p-12 justify-center items-center lg:items-end  ">
      ...
      <div className="flex basis-[47%] h-fit relative">
      <Image
